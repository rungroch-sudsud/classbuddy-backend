...
export const forgotPasswordOtpSchema = z.object({
  phone: z.string().min(10, 'เบอร์โทรต้องมีอย่างน้อย 10 หลัก').describe('เบอร์โทรศํพท์').default('0'),
});

export class forgotPasswordOtpDto extends createZodDto(forgotPasswordOtpSchema) { }
